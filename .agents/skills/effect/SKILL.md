---
name: Effect
description: Use for building robust typescript applications with proper error handling, services, dependency injection, function patterns, http server with openapi, telemetry, and more
---
